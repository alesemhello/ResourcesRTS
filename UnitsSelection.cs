...
public class UnitsSelection : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.anyKeyDown)
        {
            ...
            if (alphaKey != -1)
            {
                if (Input.GetKey(KeyCode.LeftAlt) || Input.GetKey(KeyCode.RightAlt) || Input.GetKey(KeyCode.LeftApple) || Input.GetKey(KeyCode.RightApple) || Input.GetKey(KeyCode.Z))
                {
    ...
    private void _SelectUnitsInDraggingBox()
    {
        ...
        foreach (GameObject unit in selectableUnits)
        {
            ...
            if (inBounds)
            {
                ...
                Debug.Log("_SelectUnitsInDraggingBox: Adding!");
            }
        }
    }
    ...
    private void _DeselectAllUnits()
    {
        ...
        foreach (UnitManager um in selectedUnits) um.Deselect();
    }
    ...
    {
        Debug.Log("_CreateSelectionGroup");
